...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_clk_200_to_100_clk_wiz is
  signal clk100_clk_200_to_100 : STD_LOGIC;
  signal clk_in1_clk_200_to_100 : STD_LOGIC;
  signal clkfbout_buf_clk_200_to_100 : STD_LOGIC;
  signal clkfbout_clk_200_to_100 : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clkfbout_clk_200_to_100,
      O => clkfbout_buf_clk_200_to_100
    );
...
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CDDCREQ => '0',
      CLKFBIN => clkfbout_buf_clk_200_to_100,
      CLKFBOUT => clkfbout_clk_200_to_100,
