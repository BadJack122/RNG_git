...
HD_PWD='C:/edt/RNG/RNG.runs/clk_200_to_100_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_200_to_100.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_200_to_100.tcl
