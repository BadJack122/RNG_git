...
HD_PWD='C:/edt/RNG/RNG.runs/raw_sample_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log raw_sample_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source raw_sample_fifo.tcl
