...
HD_PWD='C:/edt/RNG/RNG.runs/master_ring_pll_220m_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log master_ring_pll_220m.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source master_ring_pll_220m.tcl
