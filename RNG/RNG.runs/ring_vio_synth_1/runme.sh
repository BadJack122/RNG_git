...
HD_PWD='C:/edt/RNG/RNG.runs/ring_vio_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ring_vio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ring_vio.tcl
