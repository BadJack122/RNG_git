...
HD_PWD='C:/edt/RNG/RNG.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ring_oscillator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ring_oscillator.tcl -notrace
