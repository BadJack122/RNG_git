...
HD_PWD='C:/edt/RNG/RNG.runs/jitter_vio_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log jitter_vio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source jitter_vio.tcl
