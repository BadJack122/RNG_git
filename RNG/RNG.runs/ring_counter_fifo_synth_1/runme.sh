...
HD_PWD='C:/edt/RNG/RNG.runs/ring_counter_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ring_counter_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ring_counter_fifo.tcl
